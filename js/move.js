$(function(){
	...
	function select_url(){
		if((this_url=='www.clocktree.co.kr/')||(this_url=='www.clocktree.co.kr/index.html')||(this_url=='www.clocktree.co.kr/sub/sub1.html')||(this_url=='www.clocktree.co.kr/sub/sub2.html')||(this_url=='www.clocktree.co.kr/sub/sub3.html')||(this_url=='www.clocktree.co.kr/sub/sub4.html')||(this_url=='www.clocktree.co.kr/sub/sub5.html')){
			...
			console.log('type_5 = '+this.location.href.split('//')[0]);
            if(this.location.href.split('//')[0]=='http'){
                ...
                portfolioindex_url = 'https://www.clocktree.kr'
                console.log('type_5_2 = '+portfolioindex_url);
            }   
	...
	function box_maker(){
		...
		for (start_year=2016;start_year<=this_year;start_year++){
			...
			if($('.article-main-scrollall').find('#main-scroll'+work_years+'-con')){
				$('#main-scroll'+work_years+'-con').append('<div class="move-wrap move-wrap'+work_years+'"><div class="scrollall-con-box box-all-empty" id="scroll'+work_years+'-con-box0" aria-haspopup="true" aria-hidden="false" role="button" tabindex="0" data-empty="true"><div id="con-box'+work_years+'-imgborder0" class="con-box-imgborder">\
